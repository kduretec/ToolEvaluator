...
public class App {
	...
	private void initializeTools() {
		...
		ITool tika11 = new SoftwareTool("Apache Tika v1.1", Utils.toolOutput + "/ApacheTika1_1/text",
				Utils.resultsOutput + "/ApacheTika1_1/results", new GenericParser(), Arrays.asList("docx","odt","pdf"));
		ITool tika12 = new SoftwareTool("Apache Tika v1.2", Utils.toolOutput + "/ApacheTika1_2/text",
				Utils.resultsOutput + "/ApacheTika1_2/results", new GenericParser(), Arrays.asList("docx","odt","pdf"));
		ITool tika113 = new SoftwareTool("Apache Tika v1.13", Utils.toolOutput + "/ApacheTika1_13/text",
				Utils.resultsOutput + "/ApacheTika1_13/results", new GenericParser(), Arrays.asList("docx","odt","pdf"));
		...
		ITool docToText = new SoftwareTool("DocToText", Utils.toolOutput + "/DocToText/text",
		 ...
		 ITool abiWord = new SoftwareTool("AbiWord", Utils.toolOutput +
		 "/AbiWord/text", Utils.resultsOutput + "/AbiWord/results", new GenericParser(), Arrays.asList("docx","odt","pdf"));
		...
		ITool icecite = new SoftwareTool("icecite", Utils.toolOutput + "/icecite/text", Utils.resultsOutput + "/icecite/results",
				new GenericParser(), Arrays.asList("pdf"));
