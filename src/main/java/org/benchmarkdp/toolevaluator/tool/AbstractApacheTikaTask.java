...
public abstract class AbstractApacheTikaTask extends AbstractToolTask {

	protected String tool; 
	protected String toolName; 
	protected String toolNameNice; 
	
	public AbstractApacheTikaTask(ExperimentProperties ep, TestCase tc) {
		super(ep, tc);
